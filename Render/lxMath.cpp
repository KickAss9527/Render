...
std::cout<<"error QUAT_Print";//Write_Error("\n%s=%f+[(%f)i + (%f)j + (%f)k]", name, q->w, q->x, q->y, q->z);
...
{
    return(sqrtf(va->x*va->x + va->y*va->y));
// computes the magnitue of a vector using an approximation
// very fast
